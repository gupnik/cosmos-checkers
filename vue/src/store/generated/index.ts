...
import GupnikCheckersGupnikCheckersCheckers from './gupnik/checkers/gupnik.checkers.checkers'
...
export default { 
  ...
  GupnikCheckersGupnikCheckersCheckers: load(GupnikCheckersGupnikCheckersCheckers, 'gupnik.checkers.checkers'),
